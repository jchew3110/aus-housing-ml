...
After tuning, the best params are used to refit on the full training set.
Confidence intervals use two quantile XGBoost models.
"""
...
class XGBoostHousingModel(BaseHousingModel):
    name = "xgboost"
    ...
    def fit(self, X_train, y_train, X_val, y_val) -> None:
        ...
        logger.info("XGBoost best params: %s (val RMSE=%.4f)", self.best_params, study.best_value)
